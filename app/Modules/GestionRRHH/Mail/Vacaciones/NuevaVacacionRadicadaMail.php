...
namespace App\Modules\GestionRRHH\Mail\Vacaciones;
...
class NuevaVacacionRadicadaMail extends Mailable implements ShouldQueue
{
    use Queueable;
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: $asunto !== '' ? $asunto : 'Nueva solicitud de vacaciones radicada'
        );
    }
