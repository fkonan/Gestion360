...
use App\Modules\GestionRRHH\Models\incapacidadesSeguimiento;
use Exception;
...
class SeguimientoIncapacidadController extends Controller
{
    public function incapacidadesSeguimiento()
    {
        ...
        return view('gestionrrhh::incapacidades.listaSeguimiento', compact('incapacidadesSeguimiento'));
    }
    ...
    public function seguimientoDetalle($id)
    {
        ...
        return view('gestionrrhh::incapacidades.registroSeguimiento', compact('incapacidad', 'listaSeguimiento'));
    }
    ...
    public function nuevoSeguimiento($id)
    {
        ...
        return view('gestionrrhh::incapacidades.nuevoSeguimiento', compact('incapacidad'));
    }
