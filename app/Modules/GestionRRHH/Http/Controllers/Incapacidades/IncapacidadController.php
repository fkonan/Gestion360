...
namespace App\Modules\GestionRRHH\Http\Controllers\Incapacidades;

use App\Http\Controllers\Controller;
use App\Modules\Configuracion\Models\Parametros;
use App\Modules\GestionRRHH\Models\Arl;
...
class IncapacidadController extends Controller
{
    public function listaIncapacidades()
    {
        ...
        if ($incapacidadesPorGestionar == null) {
            ...
            return sweetAlert('No existen incapacidades radicadas pendientes de gestión en este momento.', 'success');
        }

        return view('gestionrrhh::incapacidades.index');
    }
    ...
    public function editIncapacidad($id)
    {
        ...
        return view('gestionrrhh::incapacidades.revisionIncapacidad', compact('incapacidad', 'causasIncapacidad', 'listaEps', 'listaArl', 'codigosIncapacidad'));
    }
    ...
    public function gestionIncapacidad($id)
    {
        ...
        return view('gestionrrhh::incapacidades.gestionIncapacidad', compact('incapacidad'));
    }
