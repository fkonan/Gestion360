...
class EmpleadoPermisoPdfService
{
    ...
    private function resolverRutaPlantilla(): string
    {
        ...
        $candidatas = [
            $configPath,
            base_path('app/Modules/GestionRRHH/Resources/Templates/Permisos/FormatoPermisoSalida.pdf'),
    ...
    {
        $nombreFirma = $this->normalizarTexto($nombre ?? '') ?? self::TEXTO_PENDIENTE;
        $documentoFirma = $this->normalizarTexto($documento ?? '') ?? self::TEXTO_NO_DISPONIBLE;
