...
<div class="container-fluid">
        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Aprobación Subgerencia</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col-12">
            <h3><i class="fas fa-user-shield"></i> Aprobación Subgerencia</h3>
            <p class="text-muted">Radicaciones pendientes de aprobación por subgerencia</p>
        </div>
    </div>
                ...
                <table class="table table-hover table-striped mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ \Carbon\Carbon::parse($radicacion->fecha_envio_subgerencia)->format('d/m/Y') }}<br>
                                <small class="text-muted">
                                    {{ \Carbon\Carbon::parse($radicacion->fecha_envio_subgerencia)->diffForHumans() }}
                                </small>
                            </td>
                            <td class="text-end">
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="{{ route('radfact.subgerencia.show', $radicacion) }}"
