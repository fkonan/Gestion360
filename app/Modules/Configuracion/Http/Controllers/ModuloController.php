...
class ModuloController extends Controller
{
    public function index()
    {
        ...
        return view('configuracion::modulos.index', compact('modulos'));
    }
    ...
    public function create()
    {
        ...
        return view('configuracion::modulos.crearModulo', compact('modulos', 'permisos'))->render();
    }
    ...
    public function edit($id)
    {
        ...
        return view('configuracion::modulos.editarModulo', compact('moduloEdit', 'permisos'))->render();
    }
    ...
    {
        return view('configuracion::modulos.gestionSistema');
    }

    public function getGestionEmpleado()
    {
        return view('configuracion::modulos.gestionEmpleado');
    }
}
