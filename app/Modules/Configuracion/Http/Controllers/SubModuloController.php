...
class SubModuloController extends Controller
{
    public function index()
    {
        ...
        return view('configuracion::submodulos.index', compact('subModulos'));
    }
    ...
    public function create()
    {
        ...
        return view('configuracion::submodulos.crearSubModulo', compact('modulos', 'permisos'))->render();
    }
    ...
    public function edit($id)
    {
        ...
        return view('configuracion::submodulos.editarSubModulos', compact('moduloEdit', 'permisos', 'modulos'))->render();
    }
