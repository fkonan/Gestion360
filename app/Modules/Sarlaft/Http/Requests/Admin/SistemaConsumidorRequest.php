...
class SistemaConsumidorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'modo_integracion' => $isUpdate ? 'sometimes|in:push,pull,db,consulta' : 'required|in:push,pull,db,consulta',
    ...
    public function messages(): array
    {
        return [
            ...
            'modo_integracion.in' => 'El modo de integración debe ser Push, Pull, Lectura de BD o Consulta.',
