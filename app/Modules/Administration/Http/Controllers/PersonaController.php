...
class PersonaController extends Controller
{
    ...
    {
        return view('administration::personas.index');
    }
    ...
    public function create()
    {
        ...
        return view('administration::personas.crearPersona', compact('departamentos', 'tiposDocumento'))->render();
    }
    ...
    public function show($id)
    {
        ...
        return view('administration::personas.index', compact('personas'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('administration::personas.editarPersona', compact('persona', 'tiposDocumento', 'departamentos'))->render();
    }
