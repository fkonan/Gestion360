...
<head>
   ...
   <link rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/bootstrap-duallistbox/dist/bootstrap-duallistbox.min.css" />
...
<body class="sidebar-mini sidebar-collapse layout-fixed">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
         <div class="sidebar">
            ...
            <div class="user-panel mt-3 pt-1 pb-0 d-flex flex-column" style="border: none">
               {{-- Icono cambiar theme --}}
               <button class="btn rounded-circle me-3" title="Cambiar modo oscuro" style="width: 50px"
                  data-theme-toggle>
                  <i class="light-icon"></i>
               </button>

               <div class="info d-flex flex-column align-items-center"
                  style="width: 235px; margin: 0 auto; user-select: none">
                  <img src="{{ asset('img/LogoCope.png') }}" class="logoCope" style="width: 100%; height: auto"
                     alt="Logo Cope" />
                  <img src="{{ asset('img/LogoCopeBlancoFull.png') }}" class="logoCopeBlanco py-3"
                     style="width: 80%; height: auto; display: none" alt="Logo Cope " />
               </div>
               ...
               <div class="info" style="user-select: none; font-size: 0.75em">
                  ...
                  <span class="fw-medium">
                     {{ $user->persona?->PerNombres }}
                     {{ $user->persona?->PerApellidos }}
                  </span>
                  <br />
               ...
               <div class="horaComponent info text-muted">
                  <span id="horas"></span>:<span id="minutos"></span>:<span id="segundos"></span>&nbsp;<span
                     id="ampm"></span>
      ...
      <div class="content-wrapper">
         <section class="content-header mb-4 p-2 py-1 d-flex justify-content-between align-items-center bg-primary"
            ...
            <div class="container-fluid my-2">
               <a class="pushmenu btn btn-sm text-light" data-widget="pushmenu" data-enable-remember="true"
                  href="#" role="button">
                  <i class="fas fa-bars"></i>
               </a>
               <img src="{{ asset('img/LogoCopeBlanco.png') }}" style="width: 70px; height: 15px" alt="Logo Cope"
                  class="d-md-none" />
            </div>
         </section>
   ...
   <script src="https://cdn.jsdelivr.net/npm/bootstrap-duallistbox/dist/jquery.bootstrap-duallistbox.min.js" defer>
   </script>
